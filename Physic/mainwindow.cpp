...

{
    ...
    ui->label_4->setPixmap(photo.scaled(400, 400, Qt::KeepAspectRatio));

    ui->labelPhotoText->setText("Датчик Холла расположен внутри между\nдвумя катушками, которые нужны для\nсоздания магнитного поля.");
